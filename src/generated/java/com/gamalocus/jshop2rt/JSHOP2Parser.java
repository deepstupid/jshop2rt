// $ANTLR 2.7.3-20030430: "JSHOP2.g" -> "JSHOP2Parser.java"$
...
public class JSHOP2Parser extends antlr.LLkParser implements JSHOP2TokenTypes {
    ...
    //-- the constructor.
    public void initialize(JSHOP2Lexer lexerIn, Model domainIn) {
        lexer = lexerIn;
        domain = domainIn;
    ...
    public final void prob() throws RecognitionException, TokenStreamException, IOException {
        ...
        domain.setProbName(new String(pn.getText()));
        ...
        //-- this domain.
        LinkedList<java.util.List<Predicate>> states = new LinkedList<>();
    ...
    public final Predicate la() throws RecognitionException, TokenStreamException {
        ...
        switch (LA(1)) {
            case LP: {
                ...
                //-- domain.
                int index = domain.addConstant(pn.getText());
    ...
    public final void method() throws RecognitionException, TokenStreamException {
        ...
        //-- tasks in the domain.
        int index = domain.addCompoundTask(mn.getText());
    ...
    public final void op() throws RecognitionException, TokenStreamException {
        ...
        int index = domain.addPrimitiveTask(on.getText());
    ...
    public final Vector da() throws RecognitionException, TokenStreamException {
        ...
        switch (LA(1)) {
            ...
            case VARID: {
                ...
                retVal.clear();
                retVal.add(new Integer(vars.indexOf(var.getText())));
    ...
    public final Term term() throws RecognitionException, TokenStreamException {
        ...
        switch (LA(1)) {
            case VARID: {
                ...
                if (!vars.contains(vn.getText()))
                    vars.add(vn.getText());

                //-- Create the object that represents this variable symbol.
                retVal = new TermVariable(vars.indexOf(vn.getText()));
            ...
            case ID: {
                ...
                //-- Add the constant symbol to the list of constant symbols in the
                //-- domain.
                int index = domain.addConstant(in.getText());

                //-- Create the object that represents this constant symbol.
                retVal = new TermConstant(index, domain.constants().get(index));
            ...
            case NUM: {
                ...
                retVal = new TermNumber(Double.parseDouble(num.getText()));
            ...
            default:
                if ((LA(1) == LP) && (_tokenSet_6.member(LA(2)))) {
                    ...
                    if (!func.startsWith("StdLib.")) {
                        domain.addCalc(func);
                        func = "((" + domain.getName() + ")owner).calculate" + func;
                    }
        ...
        }
        {
            switch (LA(1)) {
                case ID: {
                    ...
                    //-- domain.
                    tn = domain.addCompoundTask(ctn.getText());
                    isPrimitive = false;
                ...
                case OPID: {
                    ...
                    //-- domain.
                    tn = domain.addPrimitiveTask(stn.getText());
                    isPrimitive = true;
