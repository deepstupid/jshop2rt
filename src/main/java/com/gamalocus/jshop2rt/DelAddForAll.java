...
public class DelAddForAll extends DelAddElement {
    private static final long serialVersionUID = 4753872559130715744L;
    /**
     ...
     * @param atomsIn the atoms to be added/deleted as a <code>Vector</code>. Note that
    ...
    public DelAddForAll(LogicalExpression expIn, Vector<Predicate> atomsIn) {
        ...
        //-- are.
        atoms = atomsIn.toArray(new Predicate[0]);
     ...
     *                <code>ForAll</code> delete/add element.
     * @param atomsIn the atoms to be added/deleted as an array. Note that we use an
    ...
    public void add(State s, Term[] binding, Vector[] delAddList) {
        ...
        //-- ForAll delete/add element,
        while ((nextB = pre.nextBinding(s)) != null) {
    ...
    public void setVarCount(int varCount) {
        ...
        for (Predicate atom : atoms) atom.setVarCount(varCount);
    }
