...
public class PreconditionForAll extends Precondition {
     ...
     */
    private final Term[] currentBinding;
     ...
     */
    private final Term[] retVal;

    /**
     * To initialize this <code>ForAll</code> logical expression.
     *
     * @param premiseIn     the premise of the <code>ForAll</code> logical expression this
     *                      object represents.
     * @param consequenceIn the consequence of the <code>ForAll</code> logical expression
     *                      this object represents.
     * @param vars          the number of variables this logical expression has. This is used
    ...
    protected Term[] nextBindingHelper(State state) {
        ...
        while ((satisfier = premise.nextBinding(state)) != null) {
            ...
            if (consequence.nextBinding(state) == null)
