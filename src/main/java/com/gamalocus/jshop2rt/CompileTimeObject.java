...
public abstract class CompileTimeObject {
     ...
     *
     * @param label Descriptive label for the element, as seen from its parent. Used for comments.
     *              For small elements, this makes no sense, and <code>null</code> may be passed.
     * @return the produced code as a <code>String</code>.
     */
    protected abstract String toCode(String label);
    ...
    String getSourcePosForToString() {
        if (lineFrom != -1) {
