...
public class Predicate extends CompileTimeObject implements Serializable {
     ...
     * variable symbol.
     *
     * @param varIdxIn   the index of the variable symbol that represents this predicate.
     * @param varCountIn number of the variables of the predicate.
     */
     ...
     *
     * @return <code>true</code> if this predicate is ground, <code>false</code>
     * otherwise.
     */
     ...
     *
     * @param constants Depends on whether the predicate is a
